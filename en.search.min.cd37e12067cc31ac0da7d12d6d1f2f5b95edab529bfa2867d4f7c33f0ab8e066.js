...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/tmtmazum.bitbucket.org/flexsearch.min.js');loadScript('/tmtmazum.bitbucket.org/en.search-data.min.13c142551da97108bce20b126507da9c8976045924009a0ca88968214e20f73a.js',function(){input.required=false;search();});}
